...
class Nur < Formula
  ...
  url "https://github.com/ddanier/nur/archive/refs/tags/v0.4.2.tar.gz"
  sha256 "577d44efc4de5a6f0a069f0fd9b34c97e62154ca7341177accc945dcdb45678f"
  license "MIT"
  ...
  test do
    assert_match "0.4.2", pipe_output("#{bin}/nur --version", nil)
  end
end
