...
class Nur < Formula
  ...
  url "https://github.com/ddanier/nur/archive/refs/tags/v0.8.0.tar.gz"
  sha256 "ee5243440fc6756cf5045b8e306380fd7501e35682d7e74861db0cc8691d63c2"
  license "MIT"
  ...
  test do
    assert_match "0.8.0", pipe_output("#{bin}/nur --version", nil)
  end
end