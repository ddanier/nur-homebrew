...
class Nur < Formula
  ...
  url "https://github.com/ddanier/nur/archive/refs/tags/v0.7.0.tar.gz"
  sha256 "de6dc2e9dfe7217b32e17207c91bc86fa3c47c09034d8cc0065aa3a4659f9ab7"
  license "MIT"
  ...
  test do
    assert_match "0.7.0", pipe_output("#{bin}/nur --version", nil)
  end
end