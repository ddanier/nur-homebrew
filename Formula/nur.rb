...
class Nur < Formula
  ...
  url "https://github.com/ddanier/nur/archive/refs/tags/v0.6.2.tar.gz"
  sha256 "d4c84147d071e759705fe8e4181c62a96e6a6332c72602f9d967d66a2c4901ad"
  license "MIT"
  ...
  test do
    assert_match "0.6.2", pipe_output("#{bin}/nur --version", nil)
  end
end