...
class Nur < Formula
  ...
  url "https://github.com/ddanier/nur/archive/refs/tags/v0.11.0.tar.gz"
  sha256 "59feebc41e8c29adfaa3a5cbc1555b17f11ace743c2b8468fadb1747bd9521b1"
  license "MIT"
  ...
  test do
    assert_match "0.11.0", pipe_output("#{bin}/nur --version", nil)
  end
end