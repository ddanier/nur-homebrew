...
class Nur < Formula
  ...
  url "https://github.com/ddanier/nur/archive/refs/tags/v0.6.1.tar.gz"
  sha256 "11860d4f120d1c78682c62328f571e291cb41e271e04c60da51f319b8efc9155"
  license "MIT"
  ...
  test do
    assert_match "0.6.1", pipe_output("#{bin}/nur --version", nil)
  end
end