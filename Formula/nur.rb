...
class Nur < Formula
  ...
  url "https://github.com/ddanier/nur/archive/refs/tags/v0.5.0.tar.gz"
  sha256 "f9c02b47a5ff6a04d8b702db2413cd82e58ea0b64b4292203a041f49efe8558d"
  license "MIT"
  ...
  test do
    assert_match "0.5.0", pipe_output("#{bin}/nur --version", nil)
  end
end
