...
class Nur < Formula
  ...
  url "https://github.com/ddanier/nur/archive/refs/tags/v0.3.0.tar.gz"
  sha256 "0d0b95f23f4e19a201f6f8b7b7521238eddcfba9ef951ffdeef868db21b56a69"
  license "MIT"
  ...
  test do
    assert_match "0.3.0", pipe_output("#{bin}/nur --version", nil)
  end
end
