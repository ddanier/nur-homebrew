...
class Nur < Formula
  ...
  url "https://github.com/nur-taskrunner/nur/archive/refs/tags/v0.12.1.tar.gz"
  sha256 "d2761e9d84c119b52d50bff52e95bf7897819c061aa38b67f3b969b5db0d19ab"
  license "MIT"
  ...
  test do
    assert_match "0.12.1", pipe_output("#{bin}/nur --version", nil)
  end
end