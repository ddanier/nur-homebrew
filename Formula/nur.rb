...
class Nur < Formula
  ...
  url "https://github.com/ddanier/nur/archive/refs/tags/v0.10.0.tar.gz"
  sha256 "eeb22b83242e4d03ed08acc8bb634c2a7cd28efb2e6525758a83ddd13bfc0c47"
  license "MIT"
  ...
  test do
    assert_match "0.10.0", pipe_output("#{bin}/nur --version", nil)
  end
end