...
class Nur < Formula
  ...
  url "https://github.com/ddanier/nur/archive/refs/tags/v0.6.0.tar.gz"
  sha256 "8499e7d21296f99ccd9eba888361d340af0dad333ad1b5e7d6ae7ac8ef9db4fb"
  license "MIT"
  ...
  test do
    assert_match "0.6.0", pipe_output("#{bin}/nur --version", nil)
  end
end
